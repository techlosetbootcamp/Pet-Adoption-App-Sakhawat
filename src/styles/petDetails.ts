...
export const petDetailsStyles = StyleSheet.create({
  ...
  type: {fontSize: 15, color: COLORS.mediumGray, top: -13},
  ...
  ownerRole: {fontSize: 14, color: COLORS.lightGray, left: -60, top: 10},
  description: {fontSize: 18, color: COLORS.lightGray, marginBottom: 20},
  ...
  adoptButtonText: {color: COLORS.white, fontSize: 18, fontWeight: 'bold'},
});
