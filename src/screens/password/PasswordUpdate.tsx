...
// import  updateUserPassword  from '../../redux/slices/authSlice'; // Redux action for updating password in store
...
export default function PasswordUpdate() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Input label="Confirm New Password" value={confirmNewPassword} onChangeText={setConfirmNewPassword} secureTextEntry />
